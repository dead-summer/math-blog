...
A personal blog powered by [Typst](https://github.com/typst/typst) and [Astro](https://astro.build/).
...
The `blog-tags` index is defined in [`typ/templates/mod.typ`](./typ/templates/mod.typ) to ensure type safety. You can add your own tags.
